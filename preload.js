...
contextBridge.exposeInMainWorld("api", {
  ...
  getShipyardDataConfig: () => ipcRenderer.invoke("starhold:getShipyardDataConfig"),
  ...
  setAssignDamageDestructionPreview: (payload) => ipcRenderer.invoke("starhold:setAssignDamageDestructionPreview", payload),
  ...
  onAssignDamageDestructionPreview: exposeEventBridge("starhold:assignDamageDestructionPreview"),
